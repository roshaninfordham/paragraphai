      ...
      {phase === 'done' && scores && (
        <div className="mt-3 pt-3 border-t border-border space-y-2">
          ...
          <div className="space-y-1.5">
            <ScoreBar label="Proportion" value={scores.proportion ?? 0} color="bg-green-500" info="How well dimensions match the design intent" />
            <ScoreBar label="Symmetry" value={scores.symmetry ?? 0} color="bg-yellow-500" info="Whether symmetry goals are achieved" />
            <ScoreBar label="Features" value={scores.featureCount ?? 0} color="bg-blue-500" info="How many requested features are present" />
            <ScoreBar label="Params" value={scores.parameterRange ?? 0} color="bg-purple-500" info="Whether parameters are within valid ranges" />
          </div>
          ...
          <button
            onClick={() => {
              ...
              const lines = [
                ...
                '',
                '---',
                '*Generated by ParaGraph — AI-Native Parametric Design Studio*',
              ]
